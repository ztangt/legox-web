...
define('vs/language/html/htmlWorker', ['require'], (require) => {
  var moduleExports = (() => {
    ...
    ;(function (ScannerState2) {
      ...
      ScannerState2[(ScannerState2['AfterOpeningStartTag'] = 1)] =
        'AfterOpeningStartTag'
      ScannerState2[(ScannerState2['AfterOpeningEndTag'] = 2)] =
        'AfterOpeningEndTag'
      ...
      ScannerState2[(ScannerState2['WithinScriptContent'] = 7)] =
        'WithinScriptContent'
      ScannerState2[(ScannerState2['WithinStyleContent'] = 8)] =
        'WithinStyleContent'
      ScannerState2[(ScannerState2['AfterAttributeName'] = 9)] =
        'AfterAttributeName'
      ScannerState2[(ScannerState2['BeforeAttributeValue'] = 10)] =
    ...
    var PathCompletionParticipant = (function () {
      ...
      PathCompletionParticipant2.prototype.onHtmlAttributeValue = function (
        context
      ) {
          ...
          return __generator(this, function (_c) {
            switch (_c.label) {
              ...
              case 3:
                suggestions = _c.sent()
                for (
                  _b = 0, suggestions_1 = suggestions;
                  _b < suggestions_1.length;
                  _b++
                ) {
    ...
    var HTMLCompletion = (function () {
          ...
          return __generator2(this, function (_a2) {
            switch (_a2.label) {
              case 0:
                ...
                this.completionParticipants = [participant].concat(
                  contributedParticipants
                )
                result = this.doComplete(
                  document,
                  position,
                  htmlDocument,
                  settings
      ...
      HTMLCompletion2.prototype.doComplete = function (
        document,
        position,
        htmlDocument,
        settings
      ) {
        var result = this._doComplete(
          document,
          position,
          htmlDocument,
          settings
      ...
      HTMLCompletion2.prototype._doComplete = function (
        ...
        var dataProviders = this.dataManager
          .getDataProviders()
          .filter(function (p) {
            return (
              ...
              if (endsWith(entity, ';')) {
                ...
                result.items.push({
                  ...
                  documentation: localize3(
                    'entity.propose',
                    "Character entity representing '".concat(
                      entities[entity],
                      "'"
                    )
                  ),
      ...
      HTMLCompletion2.prototype.doTagComplete = function (
        document,
        position,
        htmlDocument
      ) {
      ...
      HTMLCompletion2.prototype.doesSupportMarkdown = function () {
        ...
        if (!isDefined(this.supportsMarkdown)) {
          ...
          var documentationFormat =
            (_c =
              (_b =
                (_a2 = this.lsOptions.clientCapabilities.textDocument) ===
                  null || _a2 === void 0
                  ? void 0
    ...
    var HTMLHover = (function () {
      ...
      HTMLHover2.prototype.doHover = function (
        document,
        position,
        htmlDocument,
        options
          ...
          var _loop_1 = function (provider2) {
            ...
            provider2.provideTags().forEach(function (tag2) {
              if (tag2.name.toLowerCase() === currTag.toLowerCase()) {
                var markupContent = generateDocumentation(
                  tag2,
                  options,
                  doesSupportMarkdown
                )
        ...
        function getAttrHover(currTag, currAttr, range) {
          var _loop_2 = function (provider2) {
            ...
            provider2.provideAttributes(currTag).forEach(function (attr2) {
              if (currAttr === attr2.name && attr2.description) {
                var contentsDoc = generateDocumentation(
                  attr2,
                  options,
                  doesSupportMarkdown
                )
          ...
          for (
            var _i = 0, dataProviders_2 = dataProviders;
            _i < dataProviders_2.length;
            _i++
          ) {
        ...
        function getAttrValueHover(currTag, currAttr, currAttrValue, range) {
          var _loop_3 = function (provider2) {
            ...
            provider2
              ...
              .forEach(function (attrValue2) {
                if (
                  currAttrValue === attrValue2.name &&
                  attrValue2.description
                ) {
                  var contentsDoc = generateDocumentation(
                    attrValue2,
                    options,
          ...
          for (
            var _i = 0, dataProviders_3 = dataProviders;
            _i < dataProviders_3.length;
            _i++
          ) {
        ...
        var attrValueRange = getTagNameRange2(
        ...
        if (attrValueRange) {
          ...
          var matchAttr = scanAttrAndAttrValue(
            node.start,
      ...
      HTMLHover2.prototype.doesSupportMarkdown = function () {
        ...
        if (!isDefined(this.supportsMarkdown)) {
          ...
          var contentFormat =
            (_c =
              (_b =
                (_a2 = this.lsOptions.clientCapabilities) === null ||
                _a2 === void 0
                  ? void 0
      ...
      var __webpack_modules__ = [
        ...
        function (module) {
          ...
          Options.prototype._get_boolean = function (name, default_value) {
            var option_value = this.raw_options[name]
            var result =
              option_value === void 0 ? !!default_value : !!option_value
            return result
          }
            ...
            var n = {
              resolve: function () {
                for (
                  ...
                  i >= 0
                    ? (a = arguments[i])
                    : (void 0 === t3 && (t3 = process.cwd()), (a = t3)),
                    e2(a),
                    0 !== a.length &&
                      ((n2 = a + '/' + n2), (o = 47 === a.charCodeAt(0)))
                }
                return (
                  (n2 = r2(n2, !o)),
                  o
              ...
              relative: function (t3, r3) {
                ...
                for (
                  var s = r3.length - h, c = a < s ? a : s, f = -1, u = 0;
                  u <= c;
                  ++u
                ) {
                  if (u === c) {
              ...
              parse: function (t3) {
                ...
                i ? ((r3.root = '/'), (n2 = 1)) : (n2 = 0)
                for (
                  var a = -1, h = 0, s = -1, c = true, f = t3.length - 1, u = 0;
                  f >= n2;
                  --f
                )
                ...
                return (
                  ...
                  (1 === u && a === s - 1 && a === h + 1)
                    ...
                    : (0 === h && i
                        ? ((r3.name = t3.slice(1, a)),
                          (r3.base = t3.slice(1, s)))
                        : ((r3.name = t3.slice(h, a)),
              ...
              y = (function (t3) {
                ...
                return (
                  ...
                  Object.defineProperty(e3.prototype, 'fsPath', {
                    get: function () {
                      return (
                        this._fsPath || (this._fsPath = A(this, false)),
                        this._fsPath
                      )
                    },
                    enumerable: false,
    ...
    function getWorkspaceUrl(documentUri, tokenContent, documentContext, base) {
      ...
      if (/^\/\//i.test(tokenContent)) {
        var pickedScheme = startsWith(documentUri, 'https://')
          ? 'https'
          : 'http'
    ...
    var HTMLDataManager = (function () {
      ...
      HTMLDataManager2.prototype.setDataProviders = function (
        builtIn,
        providers
      ) {
        var _a2
