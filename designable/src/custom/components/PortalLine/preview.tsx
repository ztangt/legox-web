...
export interface PortalLineProps {
  option: echarts.EChartsOption
}
export const PortalLine: DnFC<PortalLineProps> = observer((props) => {
...
PortalLine.Behavior = createBehavior({
  name: 'PortalLine',
  extends: ['Field'],
  selector: (node) => node.props['x-component'] === 'PortalLine',
  designerProps: {
    propsSchema: creatPortalFieldSchema(AllSchemas.PortalLine),
  },
  designerLocales: AllLocales.PortalLine,
})

PortalLine.Resource = createResource({
