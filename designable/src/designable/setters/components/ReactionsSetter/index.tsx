...
export const ReactionsSetter: React.FC<IReactionsSetterProps> = (props) => {
  ...
  const [eidtorValue, setEidtorValue] = useState()
  ...
  const formCollapse = useMemo(() => FormCollapse.createFormCollapse(['run']), [
    modalVisible,
  ])
    ...
    <>
      ...
      <Modal
        ...
        onOk={(e) => {
          ...
          form
            .submit((values) => {
              console.log('values====', values, eidtorValue)
              if (typeof values['fulfill'] != 'object') {
                values['fulfill'] = {}
              }
              values['fulfill']['run'] = eidtorValue
