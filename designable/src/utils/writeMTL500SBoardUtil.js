...
export function initWebSocket(onOk) {
  try {
    ...
    websocket.onmessage = function (evt) {
      ...
      processWebSocketResponse(dataInfos, onOk)
    }
...
export function processWebSocketResponse(wsResponse, onOk) {
  debugger
...
// initialize device
export function initMTL500SDevice(onOk) {
...
// uninitialize device
export function uninitMTL500SDevice() {
  isPolling = false
...
// clear Ink
export function clearMTL500SInk() {
