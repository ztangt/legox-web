...
define('vs/language/json/jsonWorker', ['require'], (require) => {
  var moduleExports = (() => {
    ...
    ;(function (ErrorCode2) {
      ...
      ErrorCode2[(ErrorCode2['CommentNotPermitted'] = 521)] =
        'CommentNotPermitted'
      ErrorCode2[(ErrorCode2['SchemaResolveError'] = 768)] =
        'SchemaResolveError'
    })(ErrorCode || (ErrorCode = {}))
    ...
    var ValidationResult = (function () {
      ...
      ValidationResult2.prototype.mergeEnumValues = function (
        validationResult
      ) {
        if (
          !this.enumValueMatch &&
      ...
      ValidationResult2.prototype.mergePropertyMatch = function (
    ...
    var JSONDocument = (function () {
      ...
      JSONDocument2.prototype.getNodeFromOffset = function (
        offset,
        includeRightBound
      ) {
        if (includeRightBound === void 0) {
      ...
      JSONDocument2.prototype.validate = function (
        textDocument,
        schema,
        severity
      ) {
      ...
      JSONDocument2.prototype.getMatchingSchemas = function (
        schema,
        focusOffset,
        exclude
      ) {
    ...
    function validate(n, schema, validationResult, matchingSchemas) {
      ...
      function _validateNode() {
        ...
        var testAlternatives = function (alternatives, maxOneMatch) {
          ...
          for (
            var _i2 = 0, alternatives_1 = alternatives;
            _i2 < alternatives_1.length;
            _i2++
          ) {
            ...
            if (!bestMatch) {
              ...
              if (
                ...
                var compareResult = subValidationResult2.compare(
        ...
        function normalizeFloats(float) {
          ...
          return (
            parts && {
              ...
              multiplier:
                (((_a = parts[2]) === null || _a === void 0
                  ? void 0
                  : _a.length) || 0) - (parseInt(parts[3]) || 0),
            }
          )
        }
      ...
      function _validateStringNode(
        ...
        if (
          isNumber(schema2.minLength) &&
          node2.value.length < schema2.minLength
        ) {
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: localize2(
        ...
        if (
          isNumber(schema2.maxLength) &&
          node2.value.length > schema2.maxLength
        ) {
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: localize2(
      ...
      function _validateArrayNode(
        ...
        if (
          isNumber(schema2.minItems) &&
          node2.items.length < schema2.minItems
        ) {
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: localize2(
        ...
        if (
          isNumber(schema2.maxItems) &&
          node2.items.length > schema2.maxItems
        ) {
          validationResult2.problems.push({
            location: { offset: node2.offset, length: node2.length },
            message: localize2(
      ...
      function _validateObjectNode(
        ...
        if (schema2.properties) {
          for (
            var _d = 0, _e = Object.keys(schema2.properties);
            _d < _e.length;
            _d++
          ) {
        ...
        if (schema2.patternProperties) {
          for (
            var _f = 0, _g = Object.keys(schema2.patternProperties);
            _f < _g.length;
            _f++
          ) {
            ...
            for (
              ...
              if (
                regex === null || regex === void 0
                  ? void 0
                  : regex.test(propertyName)
              ) {
                propertyProcessed(propertyName)
                var child = seenKeys[propertyName]
                if (child) {
                  var propertySchema =
                    schema2.patternProperties[propertyPattern]
                  if (isBoolean(propertySchema)) {
                    if (!propertySchema) {
                      var propertyNode = child.parent
                      validationResult2.problems.push({
                    ...
                    validationResult2.mergePropertyMatch(
                      propertyValidationResult
                    )
                  }
                }
        ...
        if (schema2.dependencies) {
          for (
            var _m = 0, _o = Object.keys(schema2.dependencies);
            _m < _o.length;
            _m++
          ) {
            var key = _o[_m]
    ...
    function parse3(textDocument, config) {
      ...
      function _parseArray(parent) {
        ...
        while (scanner.getToken() !== 4 && scanner.getToken() !== 17) {
          if (scanner.getToken() === 5) {
            ...
            _error(
              localize2('ExpectedComma', 'Expected comma'),
      ...
      function _parseProperty(parent, keysSeen) {
        ...
        if (scanner.getToken() === 6) {
          ...
          _error(
            localize2('ColonExpected', 'Colon expected'),
      ...
      if (token !== 17) {
        ...
        if (!_root) {
          ...
          _error(
            localize2('End of file expected', 'End of file expected.'),
            ErrorCode.Undefined
          )
        }
      }
    ...
    var JSONCompletion = (function () {
      ...
      JSONCompletion2.prototype.doComplete = function (
        document,
        position,
        doc
      ) {
        ...
        matchingSchemas.forEach(function (s) {
          if (s.node === node && !s.inverted) {
            ...
            if (
              ...
              var propertyNameCompletionItem = function (
                name,
                enumDescription2
              ) {
                ...
                var proposal = {
                  ...
                  documentation:
                    enumDescription2 ||
                    _this.fromMarkup(
                      schemaPropertyNames_1.markdownDescription
                    ) ||
      ...
      JSONCompletion2.prototype.addNullValueCompletion = function (
        separatorAfter,
        collector
      ) {
        collector.add({
      ...
      JSONCompletion2.prototype.addDollarSchemaCompletions = function (
        separatorAfter,
        collector
      ) {
        var _this = this
      ...
      JSONCompletion2.prototype.getFilterTextForSnippetValue = function (
        value
      ) {
      ...
      JSONCompletion2.prototype.getInsertTextForValue = function (
        value,
        separatorAfter
      ) {
      ...
      JSONCompletion2.prototype.getInsertTextForSnippetValue = function (
        value,
        separatorAfter
      ) {
      ...
      JSONCompletion2.prototype.getInsertTextForGuessedValue = function (
        value,
        separatorAfter
      ) {
        switch (typeof value) {
      ...
      JSONCompletion2.prototype.getLabelTextForMatchingNode = function (
        node,
        document
      ) {
        switch (node.type) {
      ...
      JSONCompletion2.prototype.evaluateSeparatorAfter = function (
        document,
        offset
      ) {
      ...
      JSONCompletion2.prototype.findItemAtOffset = function (
        node,
        document,
        offset
      ) {
      ...
      JSONCompletion2.prototype.isInComment = function (
        document,
        start,
        offset
      ) {
        ...
        return (
          (token === 12 || token === 13) && scanner.getTokenOffset() <= offset
        )
      }
    ...
    var JSONValidation = (function () {
      ...
      JSONValidation2.prototype.getLanguageStatus = function (
        textDocument,
        jsonDocument
      ) {
        return {
    ...
    function colorFromHex(text) {
      ...
      switch (text.length) {
        ...
        case 7:
          return {
            red:
              (hexDigit(text.charCodeAt(1)) * 16 +
                hexDigit(text.charCodeAt(2))) /
              255,
            green:
              (hexDigit(text.charCodeAt(3)) * 16 +
                hexDigit(text.charCodeAt(4))) /
              255,
            blue:
              (hexDigit(text.charCodeAt(5)) * 16 +
    ...
    var JSONDocumentSymbols = (function () {
      ...
      JSONDocumentSymbols2.prototype.findDocumentSymbols = function (
        document,
        doc,
        context
      ) {
      ...
      JSONDocumentSymbols2.prototype.findDocumentSymbols2 = function (
        document,
        doc,
        context
      ) {
      ...
      JSONDocumentSymbols2.prototype.findDocumentColors = function (
        document,
        doc,
        context
      ) {
    ...
    for (schemaName in schemaContributions.schemas) {
      ...
      for (property in schema.properties) {
        ...
        if (description) {
          ...
          console.log(
            ''
              .concat(property, ": localize('schema.json.")
              .concat(property, `', "")`)
          )
        }
      }
      ...
      var t = {
          470: (t2) => {
            function e2(t3) {
              if ('string' != typeof t3)
                throw new TypeError(
                  'Path must be a string. Received ' + JSON.stringify(t3)
                )
            }
            function r2(t3, e3) {
              for (
                var r3, n2 = '', o = 0, i = -1, a2 = 0, h = 0;
                h <= t3.length;
                ++h
              ) {
            ...
            var n = {
              resolve: function () {
                for (
                  var t3, n2 = '', o = false, i = arguments.length - 1;
                  i >= -1 && !o;
                  i--
                ) {
                  var a2
                  i >= 0
                    ? (a2 = arguments[i])
                    : (void 0 === t3 && (t3 = process.cwd()), (a2 = t3)),
                    e2(a2),
                    0 !== a2.length &&
                      ((n2 = a2 + '/' + n2), (o = 47 === a2.charCodeAt(0)))
                }
                return (
                  (n2 = r2(n2, !o)),
                  o
              ...
              join: function () {
                ...
                for (var t3, r3 = 0; r3 < arguments.length; ++r3) {
                  var o = arguments[r3]
                  e2(o),
                    o.length > 0 && (void 0 === t3 ? (t3 = o) : (t3 += '/' + o))
                }
              ...
              relative: function (t3, r3) {
                ...
                for (
                  var s = r3.length - h, c = a2 < s ? a2 : s, f2 = -1, u = 0;
                  u <= c;
                  ++u
                ) {
                  if (u === c) {
              ...
              parse: function (t3) {
                ...
                return (
                  ...
                  (1 === u && a2 === s - 1 && a2 === h + 1)
                    ? -1 !== s &&
                      (r3.base = r3.name =
                        0 === h && i ? t3.slice(1, s) : t3.slice(h, s))
                    : (0 === h && i
                        ? ((r3.name = t3.slice(1, a2)),
                          (r3.base = t3.slice(1, s)))
                        : ((r3.name = t3.slice(h, a2)),
                          (r3.base = t3.slice(h, s))),
          ...
          447: (t2, e2, r2) => {
              ...
              h =
                ((i = function (t3, e3) {
                  return (i =
                    ...
                    function (t4, e4) {
                      for (var r3 in e4)
                        Object.prototype.hasOwnProperty.call(e4, r3) &&
                          (t4[r3] = e4[r3])
                    })(t3, e3)
                }),
                function (t3, e3) {
                  ...
                  i(t3, e3),
                    (t3.prototype =
                      null === e3
                        ? Object.create(e3)
                        : ((r3.prototype = e3.prototype), new r3()))
                }),
              s = /^\w[\w\d+.-]*$/,
              c = /^\//,
              f2 = /^\/\//
                  ...
                  (t3.file = function (t4) {
                    ...
                    if (
                      ...
                      ;-1 === r3
                        ...
                        : ((e3 = t4.substring(2, r3)),
                          (t4 = t4.substring(r3) || p))
                    }
              ...
              y = (function (t3) {
                ...
                return (
                  ...
                  Object.defineProperty(e3.prototype, 'fsPath', {
                    get: function () {
                      return (
                        this._fsPath || (this._fsPath = A2(this, false)),
                        this._fsPath
                      )
                    },
                    enumerable: false,
                  ...
                  (e3.prototype.toJSON = function () {
                    ...
                    return (
                      this._fsPath &&
                        ((t4.fsPath = this._fsPath), (t4._sep = v)),
            ...
            function b(t3, e3) {
              for (var r3 = void 0, n2 = -1, o2 = 0; o2 < t3.length; o2++) {
                ...
                if (
                  ...
                  -1 !== n2 &&
                    ((r3 += encodeURIComponent(t3.substring(n2, o2))),
                    (n2 = -1)),
              ...
              return (
                -1 !== n2 && (r3 += encodeURIComponent(t3.substring(n2))),
                void 0 !== r3 ? r3 : t3
              )
            }
            function C(t3) {
                ...
                (r3 =
                  t3.authority && t3.path.length > 1 && 'file' === t3.scheme
                    ...
                    : 47 === t3.path.charCodeAt(0) &&
                      ((t3.path.charCodeAt(1) >= 65 &&
                        t3.path.charCodeAt(1) <= 90) ||
                        (t3.path.charCodeAt(1) >= 97 &&
                          t3.path.charCodeAt(1) <= 122)) &&
              ...
              if (a3) {
                if (
                  ...
                  (u2 = a3.charCodeAt(1)) >= 65 &&
                    u2 <= 90 &&
                    (a3 = '/'
                      .concat(String.fromCharCode(u2 + 32), ':')
                      .concat(a3.substr(3)))
              ...
              U = function (t3, e3, r3) {
                if (r3 || 2 === arguments.length)
                  for (var n2, o2 = 0, i2 = e3.length; o2 < i2; o2++)
                    (!n2 && o2 in e3) ||
                      (n2 || (n2 = Array.prototype.slice.call(e3, 0, o2)),
                      (n2[o2] = e3[o2]))
            ...
            !(function (t3) {
              ;(t3.joinPath = function (t4) {
                ...
                return t4.with({
                  path: I.join.apply(I, U([t4.path], e3, false)),
                })
              }),
                (t3.resolvePath = function (t4) {
                  ...
                  var n2 = t4.path || '/'
                  return t4.with({
                    path: I.resolve.apply(I, U([n2], e3, false)),
                  })
                }),
                (t3.dirname = function (t4) {
                  var e3 = I.dirname(t4.path)
                  return 1 === e3.length && 46 === e3.charCodeAt(0)
                    ? t4
                    : t4.with({ path: e3 })
                }),
      ...
      ResolvedSchema2.prototype.getSectionRecursive = function (path, schema) {
        ...
        if (schema.properties && typeof schema.properties[next]) {
          ...
          for (
            ...
            var regex = extendedRegExp(pattern)
            if (
              regex === null || regex === void 0 ? void 0 : regex.test(next)
            ) {
    ...
    var JSONSchemaService = (function () {
      ...
      JSONSchemaService2.prototype.setSchemaContributions = function (
        ...
        if (Array.isArray(schemaContributions2.schemaAssociations)) {
          ...
          for (
            ...
            var association = this.addFilePatternAssociation(
      ...
      JSONSchemaService2.prototype.addSchemaHandle = function (
        id,
      ...
      JSONSchemaService2.prototype.getOrAddSchemaHandle = function (
        id,
        unresolvedSchemaContent
      ) {
        return (
      ...
      JSONSchemaService2.prototype.addFilePatternAssociation = function (
        pattern,
        uris
      ) {
      ...
      JSONSchemaService2.prototype.resolveSchemaContent = function (
        schemaToResolve,
        handle
      ) {
        var _this = this
      ...
      JSONSchemaService2.prototype.getSchemaFromProperty = function (
        resource,
        document
      ) {
        var _a, _b
        if (
          ((_a = document.root) === null || _a === void 0
            ? void 0
            : _a.type) === 'object'
        ) {
          for (
            var _i = 0, _c = document.root.properties;
            _i < _c.length;
            _i++
          ) {
            var p = _c[_i]
      ...
      JSONSchemaService2.prototype.getSchemaURIsForResource = function (
        resource,
        document
      ) {
        var schemeId =
      ...
      JSONSchemaService2.prototype.getSchemaForResource = function (
        resource,
        document
      ) {
        if (document) {
      ...
      JSONSchemaService2.prototype.createCombinedSchema = function (
        resource,
        schemaIds
      ) {
      ...
      JSONSchemaService2.prototype.getMatchingSchemas = function (
        document,
        jsonDocument,
        schema
      ) {
        if (schema) {
          var id =
            schema.id ||
            'schemaservice://untitled/matchingSchemas/' + idCounter2++
      ...
      return {
        ...
        format: function (d, r, o) {
          ...
          var options = {
            ...
            insertSpaces:
              (o === null || o === void 0 ? void 0 : o.insertSpaces) === true,
            insertFinalNewline:
              (o === null || o === void 0 ? void 0 : o.insertFinalNewline) ===
              true,
            eol: '\n',
          }
