...
;(function () {
  ...
  ;(function (AMDLoader) {
    ...
    var ConfigurationOptionsUtil = /** @class */ (function () {
       ...
       */
      ConfigurationOptionsUtil.validateConfigurationOptions = function (
        options
      ) {
    ...
    var Configuration = /** @class */ (function () {
       ...
       */
      Configuration.prototype.isDuplicateMessageIgnoredFor = function (
        moduleId
      ) {
  ...
  ;(function (AMDLoader) {
    ...
    var NodeScriptLoader = /** @class */ (function () {
      ...
      NodeScriptLoader.prototype._getElectronRendererScriptPathOrUri =
        function (path) {
  ...
  ;(function (AMDLoader) {
    ...
    var ModuleManager = /** @class */ (function () {
      ...
      ModuleManager.prototype._createLoadError = function (moduleId, _err) {
        ...
        var neededBy = (this._inverseDependencies2[moduleId] || []).map(
          function (intModuleId) {
      ...
      ModuleManager.prototype._loadPluginDependency = function (
        ...
        load.error = function (err) {
          _this._config.onError(
            _this._createLoadError(pluginDependency.id, err)
          )
        }
        plugin.load(
  ...
  define(
    ...
    function (require, exports) {
      ...
      function getMessagesFromTranslationsService(
      ...
      function load(name, req, load, config) {
        ...
        if (!name || name.length === 0) {
          return load({
            ...
            getConfiguredDefaultLocale: () => {
              var _a
              return (_a = pluginConfig.availableLanguages) === null ||
                _a === void 0
                ? void 0
                : _a['*']
            },
            ...
            __awaiter(this, void 0, void 0, function* () {
              ...
              try {
                ...
                try {
                  ...
                  ;(_b = pluginConfig.availableLanguages) !== null &&
                  _b !== void 0
                    ? _b
  ...
  ;(function () {
    ...
    const trustedTypesPolicy =
      typeof ((_a = self.trustedTypes) === null || _a === void 0
        ? void 0
        : _a.createPolicy) === 'function'
    ...
    function loadAMDLoader() {
      return new Promise((resolve, reject) => {
        ...
        const isCrossOrigin =
          ...
          loaderSrc.substring(0, self.origin.length) !== self.origin
  ...
  define(
    __m[21 /*vs/base/common/codicons*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
      ...
      Codicon.debugStackframeDot = new Codicon(
        'debug-stackframe-dot',
        Codicon.circleSmallFilled.definition
      )
      ...
      Codicon.gitPullRequestGoToChanges = new Codicon(
        'git-pull-request-go-to-changes',
        { fontCharacter: '\\ec0b' }
      )
      Codicon.gitPullRequestNewChanges = new Codicon(
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[22 /*vs/base/common/diff/diffChange*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[23 /*vs/base/common/functional*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[11 /*vs/base/common/iterator*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[24 /*vs/base/common/keyCodes*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
      ...
      class KeyCodeStrMap {
        ...
        strToKeyCode(str) {
          return (
            this._strToKeyCode[str.toLowerCase()] || 0 /* KeyCode.Unknown */
          )
        }
      }
      ...
      for (let i = 0; i <= 193 /* ScanCode.MAX_VALUE */; i++) {
        exports.IMMUTABLE_CODE_TO_KEY_CODE[i] =
          -1 /* KeyCode.DependsOnKbLayout */
      }
      for (let i = 0; i <= 127 /* KeyCode.MAX_VALUE */; i++) {
        exports.IMMUTABLE_KEY_CODE_TO_CODE[i] =
          -1 /* ScanCode.DependsOnKbLayout */
      }
      ;(function () {
        ...
        const mappings = [
          ...
          [
            ...
            'MediaTrackPrevious',
            120 /* KeyCode.MediaTrackPrevious */,
            'MediaTrackPrevious',
            177,
            'VK_MEDIA_PREV_TRACK',
            empty,
      ...
      ;(function (KeyCodeUtils) {
        ...
        function toElectronAccelerator(keyCode) {
          if (
            keyCode >= 93 /* KeyCode.Numpad0 */ &&
            keyCode <= 108 /* KeyCode.NumpadDivide */
          ) {
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[8 /*vs/base/common/lifecycle*/],
    __M([
      0 /*require*/, 1 /*exports*/, 23 /*vs/base/common/functional*/,
      11 /*vs/base/common/iterator*/,
    ]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[12 /*vs/base/common/linkedList*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[2 /*vs/base/common/strings*/],
    __M([
      0 /*require*/, 1 /*exports*/, 20 /*vs/base/common/cache*/,
      25 /*vs/base/common/lazy*/,
    ]),
    function (require, exports, cache_1, lazy_1) {
      ...
      class CodePointIterator {
        ...
        prevCodePoint() {
          ...
          this._offset -=
            codePoint >= 65536 /* Constants.UNICODE_SUPPLEMENTARY_PLANE_BEGIN */
              ? 2
              : 1
          return codePoint
        }
        ...
        nextGraphemeLength() {
          ...
          while (!iterator.eol()) {
            ...
            const nextGraphemeBreakType =
              graphemeBreakTree.getGraphemeBreakType(iterator.nextCodePoint())
            if (
        ...
        prevGraphemeLength() {
          ...
          while (iterator.offset > 0) {
            ...
            const prevGraphemeBreakType =
              graphemeBreakTree.getGraphemeBreakType(iterator.prevCodePoint())
            if (
              breakBetweenGraphemeBreakType(
      ...
      // -- UTF-8 BOM
      exports.UTF8_BOM_CHARACTER = String.fromCharCode(
        65279 /* CharCode.UTF8_BOM */
      )
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[26 /*vs/base/common/hash*/],
    __M([0 /*require*/, 1 /*exports*/, 2 /*vs/base/common/strings*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[13 /*vs/base/common/diff/diff*/],
    __M([
      0 /*require*/, 1 /*exports*/, 22 /*vs/base/common/diff/diffChange*/,
      26 /*vs/base/common/hash*/,
    ]),
    function (require, exports, diffChange_1, hash_1) {
      ...
      class LcsDiff {
        ...
        WALKTRACE(
          ...
          let lastOriginalIndex =
            -1073741824 /* Constants.MIN_SAFE_SMALL_INTEGER */
        ...
        ComputeRecursionPoint(
          ...
          for (
            ...
            if (
              numDifferences <= 1447 /* LocalConstants.MaxDifferencesHistory */
            ) {
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[27 /*vs/base/common/objects*/],
    __M([0 /*require*/, 1 /*exports*/, 6 /*vs/base/common/types*/]),
        ...
        if ((0, types_1.isObject)(source)) {
          Object.keys(source).forEach((key) => {
            if (key in destination) {
              if (overwrite) {
                if (
                  (0, types_1.isObject)(destination[key]) &&
                  (0, types_1.isObject)(source[key])
                ) {
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[15 /*vs/editor/common/core/characterClassifier*/],
    __M([0 /*require*/, 1 /*exports*/, 14 /*vs/base/common/uint*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[4 /*vs/editor/common/core/range*/],
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[28 /*vs/editor/common/core/selection*/],
    __M([
      0 /*require*/, 1 /*exports*/, 3 /*vs/editor/common/core/position*/,
      4 /*vs/editor/common/core/range*/,
    ]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[29 /*vs/editor/common/core/wordCharacterClassifier*/],
    __M([
      0 /*require*/, 1 /*exports*/,
      15 /*vs/editor/common/core/characterClassifier*/,
    ]),
    function (require, exports, characterClassifier_1) {
        ...
        constructor(wordSeparators) {
          ...
          for (let i = 0, len = wordSeparators.length; i < len; i++) {
            this.set(
              ...
              2 /* WordCharacterClass.WordSeparator */
            )
          }
          this.set(
            32 /* CharCode.Space */,
      ...
      exports.getMapForWordSeparators = once(
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[16 /*vs/editor/common/core/wordHelper*/],
    __M([
      0 /*require*/, 1 /*exports*/, 11 /*vs/base/common/iterator*/,
      12 /*vs/base/common/linkedList*/,
    ]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[30 /*vs/editor/common/diff/diffComputer*/],
    __M([
      0 /*require*/, 1 /*exports*/, 13 /*vs/base/common/diff/diff*/,
      2 /*vs/base/common/strings*/,
    ]),
      ...
      class CharChange {
        ...
        static createFromDiffChange(
          ...
          const originalStartLineNumber =
            originalCharSequence.getStartLineNumber(diffChange.originalStart)
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[31 /*vs/editor/common/languages/linkComputer*/],
    __M([
      0 /*require*/, 1 /*exports*/,
      15 /*vs/editor/common/core/characterClassifier*/,
    ]),
    function (require, exports, characterClassifier_1) {
      ...
      function getStateMachine() {
        if (_stateMachine === null) {
          _stateMachine = new StateMachine([
            ...
            [
              5 /* State.HTTP */, 115 /* CharCode.s */,
              9 /* State.BeforeColon */,
            ],
            [
              5 /* State.HTTP */, 83 /* CharCode.S */,
              9 /* State.BeforeColon */,
            ],
            [
              5 /* State.HTTP */, 58 /* CharCode.Colon */,
              10 /* State.AfterColon */,
            ],
            ...
            [
              11 /* State.AlmostThere */, 47 /* CharCode.Slash */,
              12 /* State.End */,
            ],
          ])
        }
      ...
      function getClassifier() {
        if (_classifier === null) {
          _classifier = new characterClassifier_1.CharacterClassifier(
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[32 /*vs/editor/common/languages/supports/inplaceReplaceSupport*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[33 /*vs/editor/common/model*/],
    __M([0 /*require*/, 1 /*exports*/, 27 /*vs/base/common/objects*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[34 /*vs/editor/common/model/prefixSumComputer*/],
    __M([
      0 /*require*/, 1 /*exports*/, 19 /*vs/base/common/arrays*/,
      14 /*vs/base/common/uint*/,
    ]),
    function (require, exports, arrays_1, uint_1) {
      ...
      class ConstantTimePrefixSumComputer {
        ...
        insertValues(insertIndex, insertArr) {
          this._values = (0, arrays_1.arrayInsert)(
            this._values,
            insertIndex,
            insertArr
          )
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[35 /*vs/editor/common/model/mirrorTextModel*/],
    __M([
      0 /*require*/, 1 /*exports*/, 2 /*vs/base/common/strings*/,
      3 /*vs/editor/common/core/position*/,
      34 /*vs/editor/common/model/prefixSumComputer*/,
    ]),
      ...
      class MirrorTextModel {
        ...
        _ensureLineStarts() {
          if (!this._lineStarts) {
            ...
            this._lineStarts = new prefixSumComputer_1.PrefixSumComputer(
              lineStartValues
            )
          }
        }
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[36 /*vs/editor/common/model/textModelSearch*/],
    __M([
      0 /*require*/, 1 /*exports*/, 2 /*vs/base/common/strings*/,
      29 /*vs/editor/common/core/wordCharacterClassifier*/,
      3 /*vs/editor/common/core/position*/, 4 /*vs/editor/common/core/range*/,
      33 /*vs/editor/common/model*/,
    ]),
    function (
      require,
      exports,
      ...
      class SearchParams {
        ...
        parseSearchRequest() {
          ...
          return new model_1.SearchData(
            regex,
            this.wordSeparators
              ? (0, wordCharacterClassifier_1.getMapForWordSeparators)(
                  this.wordSeparators
                )
              : null,
      ...
      class TextModelSearch {
        ...
        static _doFindNextMatchMultiline(
          ...
          const searchTextStart = new position_1.Position(
      ...
      function leftIsWordBounday(
        ...
        if (
          wordSeparators.get(charBefore) !== 0 /* WordCharacterClass.Regular */
        ) {
      ...
      function rightIsWordBounday(
        ...
        if (
          wordSeparators.get(charAfter) !== 0 /* WordCharacterClass.Regular */
        ) {
        ...
        if (matchLength > 0) {
          ...
          if (
            wordSeparators.get(lastCharInMatch) !==
            0 /* WordCharacterClass.Regular */
          ) {
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[37 /*vs/editor/common/services/unicodeTextModelHighlighter*/],
    __M([
      0 /*require*/, 1 /*exports*/, 4 /*vs/editor/common/core/range*/,
      36 /*vs/editor/common/model/textModelSearch*/,
      2 /*vs/base/common/strings*/, 6 /*vs/base/common/types*/,
      16 /*vs/editor/common/core/wordHelper*/,
    ]),
    function (
      require,
      exports,
          ...
          forLoop: for (
            ...
            do {
              ...
              if (m) {
                ...
                const word = (0, wordHelper_1.getWordAtText)(
                  startIndex + 1,
                ...
                if (highlightReason !== 0 /* SimpleHighlightReason.None */) {
                  if (
                    highlightReason === 3 /* SimpleHighlightReason.Ambiguous */
                  ) {
                    ...
                    highlightReason ===
                    1 /* SimpleHighlightReason.NonBasicASCII */
                  ) {
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[38 /*vs/editor/common/standalone/standaloneEnums*/],
    __M([0 /*require*/, 1 /*exports*/]),
    function (require, exports) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
      ...
      ;(function (EditorOption) {
        ...
        EditorOption[(EditorOption['emptySelectionClipboard'] = 33)] =
          'emptySelectionClipboard'
        EditorOption[(EditorOption['experimental'] = 34)] = 'experimental'
        EditorOption[(EditorOption['extraEditorClassName'] = 35)] =
          'extraEditorClassName'
        EditorOption[(EditorOption['fastScrollSensitivity'] = 36)] =
          'fastScrollSensitivity'
        EditorOption[(EditorOption['find'] = 37)] = 'find'
        EditorOption[(EditorOption['fixedOverflowWidgets'] = 38)] =
          'fixedOverflowWidgets'
        EditorOption[(EditorOption['folding'] = 39)] = 'folding'
        EditorOption[(EditorOption['foldingStrategy'] = 40)] = 'foldingStrategy'
        EditorOption[(EditorOption['foldingHighlight'] = 41)] =
          'foldingHighlight'
        EditorOption[(EditorOption['foldingImportsByDefault'] = 42)] =
          'foldingImportsByDefault'
        EditorOption[(EditorOption['foldingMaximumRegions'] = 43)] =
          'foldingMaximumRegions'
        EditorOption[(EditorOption['unfoldOnClickAfterEndOfLine'] = 44)] =
        ...
        EditorOption[(EditorOption['hideCursorInOverviewRuler'] = 54)] =
        ...
        EditorOption[(EditorOption['mouseWheelScrollSensitivity'] = 69)] =
          'mouseWheelScrollSensitivity'
        EditorOption[(EditorOption['mouseWheelZoom'] = 70)] = 'mouseWheelZoom'
        EditorOption[(EditorOption['multiCursorMergeOverlapping'] = 71)] =
          'multiCursorMergeOverlapping'
        EditorOption[(EditorOption['multiCursorModifier'] = 72)] =
          'multiCursorModifier'
        EditorOption[(EditorOption['multiCursorPaste'] = 73)] =
          'multiCursorPaste'
        EditorOption[(EditorOption['occurrencesHighlight'] = 74)] =
          'occurrencesHighlight'
        EditorOption[(EditorOption['overviewRulerBorder'] = 75)] =
          'overviewRulerBorder'
        EditorOption[(EditorOption['overviewRulerLanes'] = 76)] =
          'overviewRulerLanes'
        EditorOption[(EditorOption['padding'] = 77)] = 'padding'
        EditorOption[(EditorOption['parameterHints'] = 78)] = 'parameterHints'
        EditorOption[(EditorOption['peekWidgetDefaultFocus'] = 79)] =
          'peekWidgetDefaultFocus'
        EditorOption[(EditorOption['definitionLinkOpensInPeek'] = 80)] =
          'definitionLinkOpensInPeek'
        EditorOption[(EditorOption['quickSuggestions'] = 81)] =
          'quickSuggestions'
        EditorOption[(EditorOption['quickSuggestionsDelay'] = 82)] =
          'quickSuggestionsDelay'
        EditorOption[(EditorOption['readOnly'] = 83)] = 'readOnly'
        EditorOption[(EditorOption['renameOnType'] = 84)] = 'renameOnType'
        EditorOption[(EditorOption['renderControlCharacters'] = 85)] =
          'renderControlCharacters'
        EditorOption[(EditorOption['renderFinalNewline'] = 86)] =
          'renderFinalNewline'
        EditorOption[(EditorOption['renderLineHighlight'] = 87)] =
          'renderLineHighlight'
        EditorOption[(EditorOption['renderLineHighlightOnlyWhenFocus'] = 88)] =
          'renderLineHighlightOnlyWhenFocus'
        EditorOption[(EditorOption['renderValidationDecorations'] = 89)] =
          'renderValidationDecorations'
        EditorOption[(EditorOption['renderWhitespace'] = 90)] =
          'renderWhitespace'
        EditorOption[(EditorOption['revealHorizontalRightPadding'] = 91)] =
          'revealHorizontalRightPadding'
        EditorOption[(EditorOption['roundedSelection'] = 92)] =
          'roundedSelection'
        EditorOption[(EditorOption['rulers'] = 93)] = 'rulers'
        EditorOption[(EditorOption['scrollbar'] = 94)] = 'scrollbar'
        EditorOption[(EditorOption['scrollBeyondLastColumn'] = 95)] =
          'scrollBeyondLastColumn'
        EditorOption[(EditorOption['scrollBeyondLastLine'] = 96)] =
          'scrollBeyondLastLine'
        EditorOption[(EditorOption['scrollPredominantAxis'] = 97)] =
          'scrollPredominantAxis'
        EditorOption[(EditorOption['selectionClipboard'] = 98)] =
          'selectionClipboard'
        EditorOption[(EditorOption['selectionHighlight'] = 99)] =
          'selectionHighlight'
        EditorOption[(EditorOption['selectOnLineNumbers'] = 100)] =
          'selectOnLineNumbers'
        EditorOption[(EditorOption['showFoldingControls'] = 101)] =
          'showFoldingControls'
        EditorOption[(EditorOption['showUnused'] = 102)] = 'showUnused'
        EditorOption[(EditorOption['snippetSuggestions'] = 103)] =
          'snippetSuggestions'
        EditorOption[(EditorOption['smartSelect'] = 104)] = 'smartSelect'
        EditorOption[(EditorOption['smoothScrolling'] = 105)] =
          'smoothScrolling'
        EditorOption[(EditorOption['stickyTabStops'] = 106)] = 'stickyTabStops'
        EditorOption[(EditorOption['stopRenderingLineAfter'] = 107)] =
          'stopRenderingLineAfter'
        EditorOption[(EditorOption['suggest'] = 108)] = 'suggest'
        EditorOption[(EditorOption['suggestFontSize'] = 109)] =
          'suggestFontSize'
        EditorOption[(EditorOption['suggestLineHeight'] = 110)] =
          'suggestLineHeight'
        EditorOption[(EditorOption['suggestOnTriggerCharacters'] = 111)] =
          'suggestOnTriggerCharacters'
        EditorOption[(EditorOption['suggestSelection'] = 112)] =
          'suggestSelection'
        EditorOption[(EditorOption['tabCompletion'] = 113)] = 'tabCompletion'
        EditorOption[(EditorOption['tabIndex'] = 114)] = 'tabIndex'
        EditorOption[(EditorOption['unicodeHighlighting'] = 115)] =
          'unicodeHighlighting'
        EditorOption[(EditorOption['unusualLineTerminators'] = 116)] =
        ...
        EditorOption[(EditorOption['wordWrapBreakAfterCharacters'] = 121)] =
          'wordWrapBreakAfterCharacters'
        EditorOption[(EditorOption['wordWrapBreakBeforeCharacters'] = 122)] =
          'wordWrapBreakBeforeCharacters'
        EditorOption[(EditorOption['wordWrapColumn'] = 123)] = 'wordWrapColumn'
        EditorOption[(EditorOption['wordWrapOverride1'] = 124)] =
          'wordWrapOverride1'
        EditorOption[(EditorOption['wordWrapOverride2'] = 125)] =
          'wordWrapOverride2'
        EditorOption[(EditorOption['wrappingIndent'] = 126)] = 'wrappingIndent'
        EditorOption[(EditorOption['wrappingStrategy'] = 127)] =
          'wrappingStrategy'
        EditorOption[(EditorOption['showDeprecated'] = 128)] = 'showDeprecated'
        EditorOption[(EditorOption['inlayHints'] = 129)] = 'inlayHints'
        EditorOption[(EditorOption['editorClassName'] = 130)] =
          'editorClassName'
  ...
  define(
    __m[39 /*vs/nls!vs/base/common/platform*/],
    __M([18 /*vs/nls*/, 46 /*vs/nls!vs/base/common/worker/simpleWorker*/]),
    function (nls, data) {
      return nls.create('vs/base/common/platform', data)
    }
  )
  define(
    __m[5 /*vs/base/common/platform*/],
    __M([0 /*require*/, 1 /*exports*/, 39 /*vs/nls!vs/base/common/platform*/]),
    function (require, exports, nls) {
      ...
      exports.isWebWorker =
        _isWeb && typeof exports.globals.importScripts === 'function'
      ...
      exports.setTimeout0IsFaster =
        typeof exports.globals.postMessage === 'function' &&
      ...
      exports.isChrome = !!(
        exports.userAgent && exports.userAgent.indexOf('Chrome') >= 0
      )
      exports.isFirefox = !!(
        exports.userAgent && exports.userAgent.indexOf('Firefox') >= 0
      )
      exports.isSafari = !!(
        !exports.isChrome &&
        exports.userAgent &&
      ...
      exports.isEdge = !!(
        exports.userAgent && exports.userAgent.indexOf('Edg/') >= 0
      )
      exports.isAndroid = !!(
        exports.userAgent && exports.userAgent.indexOf('Android') >= 0
      )
    }
  )
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[40 /*vs/base/common/process*/],
    __M([0 /*require*/, 1 /*exports*/, 5 /*vs/base/common/platform*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[41 /*vs/base/common/path*/],
    __M([0 /*require*/, 1 /*exports*/, 40 /*vs/base/common/process*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[17 /*vs/base/common/stopwatch*/],
    __M([0 /*require*/, 1 /*exports*/, 5 /*vs/base/common/platform*/]),
    function (require, exports, platform_1) {
      'use strict'
      Object.defineProperty(exports, '__esModule', { value: true })
  ...
  define(
    __m[7 /*vs/base/common/event*/],
    __M([
      0 /*require*/, 1 /*exports*/, 10 /*vs/base/common/errors*/,
      8 /*vs/base/common/lifecycle*/, 12 /*vs/base/common/linkedList*/,
      17 /*vs/base/common/stopwatch*/,
    ]),
    function (
      require,
      exports,
        ...
        class ChainableEvent {
          ...
          reduce(merge, initial) {
            return new ChainableEvent(
              reduce(this.event, merge, initial, this.disposables)
            )
          }
          latch() {
            return new ChainableEvent(
              latch(this.event, undefined, this.disposables)
            )
          }
          ...
          if (!this._event) {
            this._event = (callback, thisArgs, disposables) => {
              ...
              const result = listener.subscription.set(() => {
                removeMonitor === null || removeMonitor === void 0
                  ? void 0
                  : removeMonitor()
                if (!this._disposed) {
                  removeListener()
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[42 /*vs/base/common/cancellation*/],
    __M([0 /*require*/, 1 /*exports*/, 7 /*vs/base/common/event*/]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[9 /*vs/base/common/uri*/],
    __M([
      0 /*require*/, 1 /*exports*/, 41 /*vs/base/common/path*/,
      5 /*vs/base/common/platform*/,
    ]),
      ...
      function encodeURIComponentFast(uriComponent, allowSlash) {
        ...
        for (let pos = 0; pos < uriComponent.length; pos++) {
          ...
          if (
            ...
            (code >= 48 /* CharCode.Digit0 */ &&
              code <= 57) /* CharCode.Digit9 */ ||
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[47 /*vs/base/common/worker/simpleWorker*/],
    __M([
      0 /*require*/, 1 /*exports*/, 10 /*vs/base/common/errors*/,
      7 /*vs/base/common/event*/, 8 /*vs/base/common/lifecycle*/,
      5 /*vs/base/common/platform*/, 6 /*vs/base/common/types*/,
      2 /*vs/base/common/strings*/,
    ]),
    function (
      require,
        ...
        listen(eventName, arg) {
          ...
          const emitter = new event_1.Emitter({
            onFirstListenerAdd: () => {
              ...
              this._send(
                new SubscribeEventMessage(this._workerId, req, eventName, arg)
              )
            },
            onLastListenerRemove: () => {
          ...
          result.then(
            ...
            (e) => {
              if (e.detail instanceof Error) {
                ...
                e.detail = (0, errors_1.transformErrorForSerialization)(
                  e.detail
                )
              }
              this._send(
      ...
      class SimpleWorkerClient extends lifecycle_1.Disposable {
        constructor(workerFactory, moduleId, host) {
          ...
          if (
            typeof platform_1.globals.require !== 'undefined' &&
            typeof platform_1.globals.require.getConfig === 'function'
          ) {
            ...
            loaderConfiguration =
              platform_1.globals.requirejs.s.contexts._.config
          }
  ...
  define(
    __m[43 /*vs/editor/common/tokenizationRegistry*/],
    __M([
      0 /*require*/, 1 /*exports*/, 7 /*vs/base/common/event*/,
      8 /*vs/base/common/lifecycle*/,
    ]),
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[44 /*vs/editor/common/languages*/],
    __M([
      0 /*require*/, 1 /*exports*/, 21 /*vs/base/common/codicons*/,
      9 /*vs/base/common/uri*/, 4 /*vs/editor/common/core/range*/,
      43 /*vs/editor/common/tokenizationRegistry*/,
    ]),
    function (
      require,
      exports,
      ...
      ;(function (CompletionItemKinds) {
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolMethod
        )
        byKind.set(
          1 /* CompletionItemKind.Function */,
          codicons_1.Codicon.symbolFunction
        )
        byKind.set(
          2 /* CompletionItemKind.Constructor */,
          codicons_1.Codicon.symbolConstructor
        )
        byKind.set(
          3 /* CompletionItemKind.Field */,
          codicons_1.Codicon.symbolField
        )
        byKind.set(
          4 /* CompletionItemKind.Variable */,
          codicons_1.Codicon.symbolVariable
        )
        byKind.set(
          5 /* CompletionItemKind.Class */,
          codicons_1.Codicon.symbolClass
        )
        byKind.set(
          6 /* CompletionItemKind.Struct */,
          codicons_1.Codicon.symbolStruct
        )
        byKind.set(
          7 /* CompletionItemKind.Interface */,
          codicons_1.Codicon.symbolInterface
        )
        byKind.set(
          8 /* CompletionItemKind.Module */,
          codicons_1.Codicon.symbolModule
        )
        byKind.set(
          9 /* CompletionItemKind.Property */,
          codicons_1.Codicon.symbolProperty
        )
        byKind.set(
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolOperator
        )
        byKind.set(
          12 /* CompletionItemKind.Unit */,
          codicons_1.Codicon.symbolUnit
        )
        byKind.set(
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolEnum
        )
        byKind.set(
          14 /* CompletionItemKind.Constant */,
          codicons_1.Codicon.symbolConstant
        )
        byKind.set(
          15 /* CompletionItemKind.Enum */,
          codicons_1.Codicon.symbolEnum
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolEnumMember
        )
        byKind.set(
          17 /* CompletionItemKind.Keyword */,
          codicons_1.Codicon.symbolKeyword
        )
        byKind.set(
          27 /* CompletionItemKind.Snippet */,
          codicons_1.Codicon.symbolSnippet
        )
        byKind.set(
          18 /* CompletionItemKind.Text */,
          codicons_1.Codicon.symbolText
        )
        byKind.set(
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolFile
        )
        byKind.set(
          21 /* CompletionItemKind.Reference */,
          codicons_1.Codicon.symbolReference
        )
        byKind.set(
          22 /* CompletionItemKind.Customcolor */,
          codicons_1.Codicon.symbolCustomColor
        )
        byKind.set(
          23 /* CompletionItemKind.Folder */,
          codicons_1.Codicon.symbolFolder
        )
        byKind.set(
      ...
      ;(function (SymbolKinds) {
        ...
        byKind.set(
          ...
          codicons_1.Codicon.symbolNamespace
        )
        ...
        byKind.set(
          16 /* SymbolKind.Boolean */,
          codicons_1.Codicon.symbolBoolean
        )
       ...
       */
      exports.TokenizationRegistry =
        new tokenizationRegistry_1.TokenizationRegistry()
    }
  )
   ...
   *--------------------------------------------------------------------------------------------*/
  define(
    __m[45 /*vs/editor/common/services/editorBaseApi*/],
    __M([
      0 /*require*/, 1 /*exports*/, 42 /*vs/base/common/cancellation*/,
      7 /*vs/base/common/event*/, 24 /*vs/base/common/keyCodes*/,
      9 /*vs/base/common/uri*/, 3 /*vs/editor/common/core/position*/,
      4 /*vs/editor/common/core/range*/, 28 /*vs/editor/common/core/selection*/,
      44 /*vs/editor/common/languages*/,
      38 /*vs/editor/common/standalone/standaloneEnums*/,
    ]),
    function (
      require,
      exports,
  ...
  define(
    __m[48 /*vs/editor/common/services/editorSimpleWorker*/],
    __M([
      0 /*require*/, 1 /*exports*/, 13 /*vs/base/common/diff/diff*/,
      5 /*vs/base/common/platform*/, 9 /*vs/base/common/uri*/,
      3 /*vs/editor/common/core/position*/, 4 /*vs/editor/common/core/range*/,
      30 /*vs/editor/common/diff/diffComputer*/,
      35 /*vs/editor/common/model/mirrorTextModel*/,
      16 /*vs/editor/common/core/wordHelper*/,
      31 /*vs/editor/common/languages/linkComputer*/,
      32 /*vs/editor/common/languages/supports/inplaceReplaceSupport*/,
      45 /*vs/editor/common/services/editorBaseApi*/,
      6 /*vs/base/common/types*/, 17 /*vs/base/common/stopwatch*/,
      37 /*vs/editor/common/services/unicodeTextModelHighlighter*/,
    ]),
    function (
      require,
      exports,
      ...
      class EditorSimpleWorker {
        ...
        static computeDiff(
          ...
          const diffComputer = new diffComputer_1.DiffComputer(
            originalLines,
            modifiedLines,
            {
          ...
          return __awaiter(this, void 0, void 0, function* () {
            ...
            for (let { range, text, eol } of edits) {
              ...
              const editOffset = model.offsetAt(
                range_1.Range.lift(range).getStartPosition()
              )
              for (const change of changes) {
        ...
        navigateValueSet(modelUrl, range, up, wordDef, wordDefFlags) {
          return __awaiter(this, void 0, void 0, function* () {
            ...
            const result =
              inplaceReplaceSupport_1.BasicInplaceReplace.INSTANCE.navigateValueSet(
                range,
                selectionText,
                wordRange,
                word,
