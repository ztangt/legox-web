...
export default {
  ...
  effects: {
    ...
    *findNormExecuteInfoByBeforeId(
      { payload, callback },
      { call, put, select },
    ) {
      try {
        const { data } = yield call(
          apis.findNormExecuteInfoByBeforeId,
          payload,
          '',
          'freezeOrExec',
        );
    ...
    *findNormFreeBySourceIdList({ payload, callback }, { call, put, select }) {
      try {
        const { data } = yield call(
          apis.findNormFreeBySourceIdList,
          payload,
          '',
          'freezeOrExec',
        );
