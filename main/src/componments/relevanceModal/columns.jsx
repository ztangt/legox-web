...
export function renderCol(orgUserType, removeOnClick) {
  const usersCol = [
    ...
    },
    {
      ...
      render: text => (
        <div
          ...
          title={text ? text.split('>')[text.split('>').length - 1] : ''}
        >
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          <a
            onClick={removeOnClick.bind(
              this,
              record.orgRefUserId?record.orgRefUserId:record.identityId,
              record.orgRefUserId?'orgRefUserId':'identityId',
            )}
            className={styles.delete_color}
          >
            删除
          </a>
        );
  ...
  const userGsCol = [
    ...
    },
    {
      ...
      render: (text, record) => {
        return (
          <a onClick={removeOnClick.bind(this, record.nodeId, 'nodeId')}>
            删除
          </a>
        );
      },
