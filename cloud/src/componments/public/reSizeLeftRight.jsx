...
const ReSizeLeftRight=(props)=>{
  const [vNum,setVNum]=useState(234);
  ...
  */
  ...
  return (
    <div
      ...
      style={props.style}
    >
      <div className={styles.left} style={{width:vNum-12}} id={`h_resize_container_${props.suffix}_${props.level}`}>
        {props.leftChildren}
      </div>
      <div style={{ left:vNum,top:props.lineTop }} draggable={false} onMouseDown={vResizeDown} className={styles.v_resize}>
