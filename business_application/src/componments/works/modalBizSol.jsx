...
function ModalBizSol({dispatch,stateObj,nameSpace,showSolFn,taskType,loading,form}){
  ...
  return (
    <Modal
      ...
      maskClosable={false}
      getContainer={() =>{
          return document.getElementById(`modal_biz_sol_${taskType}`)
      }}
      footer={[
          <Button key="cancel" onClick={showSolFn.bind(this,false)}>取消</Button>,
...
export default connect(({work,loading})=>{return {loading}})(ModalBizSol)
