...
function Index({
            ...
            dispatch({
                ...
                callback: (importId) => {
                    ...
                    tempInterval = setInterval(() => {
                        dispatch({
                            type: 'budgetLedger/refreshImportExcel',
                            payload: {
                                importId,
                                // bizSolId,
                                // importType: importType,
    ...
    return (
        <GlobalModal
            ...
            mask={false}
            getContainer={() => {
                return document.getElementById('budgetLedger_id') || false;
            }}
        ...
        >
            <div className="flex flex_align_start flex_justify_between">
                ...
                <IUpload
                    ...
                    requireFileSize={5}
                    buttonContent={<Button disabled={importLoading}>导入dasd</Button>}
                />
            </div>
            <Form>
