...
const Index = ({
    ...
    const { companyList, backAccountList, orgList } = businessCardCheckedNew;
    ...
    const changeOrg = (value) => {
        if (value) {
            dispatch({ type: 'businessCardCheckedNew/getBankAccount', payload: { orgId: value } });
        }
    };
    ...
    return (
        <div id="businessCardCheckedNew_list_head" className="pt10">
...
export default connect(({ businessCardCheckedNew }) => ({ businessCardCheckedNew }))(Index);
