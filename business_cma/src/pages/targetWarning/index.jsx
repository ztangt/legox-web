...
import TargetModal from '../budgetTarget/components/targetModal';
...
function Index({ dispatch, targetWarning }) {
    ...
    const columns = [
        ...
        },
        {
            ...
            key: 'JAN_RATIO',
            ellipsis: true,
            render: (text, record, index) => <span>{text ? `${Number(text)}%` : '-'}</span>,
        },
        ,
        {
            title: '二月比例',
    ...
    return (
        <div className={styles.container} id="targetWarning_id">
            <div className={styles.header}>
                <div>
                    <Select defaultValue={usedYear} style={{ width: 80, marginRight: 8 }} onChange={onYearChange}>
