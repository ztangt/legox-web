    ...
    const onFinish = (values) => {
        ...
        dispatch({
            ...
            payload: {
                bizSolId,
                usedYear,
                idList: selectedRowKeys.toString(),
                startTime,
                endTime,
                filePath: '/normExport/报账卡导出模板.xlsx', //写死
                fileName,
                seniorSearchInfo: JSON.stringify(searchForm), //给后端传当前选择的搜索条件
                //旧版的参数
                // fileName,
                // exportFileType,
                // exportDataType,
                ...
                // searchWord: '',
                // fileType: 'CMA_BUDGET_NORM_JURISDICTION',
                // usedYear,
                // serviceName: 'CMA_APP',
            },
            callback: (url) => {
