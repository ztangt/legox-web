...
const Index = ({ dispatch, dataEntrySumTable, getPage }) => {
    ...
    const onSearch = () => {
        ...
        dispatch({ type: 'dataEntrySumTable/updateStates', payload: { formInfo: { ...formInfo, ...values } } });
        getPage();
    };

    return (
        <div id="dataEntrySumTable_head_id">
...
export default connect(({ dataEntrySumTable }) => ({
    dataEntrySumTable,
}))(Index);
