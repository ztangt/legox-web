...
import { Checkbox, Input, message, Popover, Row } from 'antd';
import { useEffect, useState } from 'react';
import { Button } from '../TLAntd';
import styles from './list.less';
const { Search } = Input;
function SetCol({ changeColVisiblePop, taskType, colVisiblePop, saveCols, defalutCols, defalutColumnCode, id }) {
    ...
    useEffect(() => {
        if (colVisiblePop) {
            ...
            setIndeterminate(!!defalutColumnCode.length && defalutColumnCode.length < defalutCols.length);
        }
    }, [colVisiblePop]);
    //去掉搜索
    // const changeColFn=(e)=>{
