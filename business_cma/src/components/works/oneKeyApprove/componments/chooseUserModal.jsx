...
import ReSizeLeftRightCss from '../../../resizeLeftRight';
import styles from './chooseUserModal.less';
            ...
            <div className={styles.submitWrap}>
                <Tabs activeKey={groupActiveKey} onChange={tabCallback}>
                    {GROUPTYPE.map((item, index) => {
                        return <TabPane tab={item.nodeName} key={item.nodeId} style={{ margin: '0 10px' }}></TabPane>;
                    })}
                </Tabs>
                <ReSizeLeftRightCss
