...
import { PADDING_HEIGHT, TABLE_HEAD_HEIGHT, PAGE_NATION_HEIGHT } from '../../util/constant';
...
class BasicsTable extends React.Component {
    ...
    onResize() {
        const { dispatch, modulesName, container = 'dom_container', listHead = 'list_head' } = this.props;
        if (!dispatch) {
            return;
        }
        this.setState(
            ...
            () => {
                dispatch({
                    ...
                    payload: {
                        ...
                        currentHeight: this.state.height - 2 * TABLE_HEAD_HEIGHT - PAGE_NATION_HEIGHT,
                    },
                });
            },
        );
