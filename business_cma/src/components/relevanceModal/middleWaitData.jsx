...
function MiddleUserAccredit({
    ...
    const changeSelect = (e) => {
        ...
        if (selectButtonType == 'checkBox') {
            if (e.target.checked) {
                ...
                newSelectedUsers = selectedDatas.filter((item) => item[idKey] != e.target.value);
            }
        } else {
            if (e.target.checked) {
                //添加
    ...
    const indeterminate = curTreeSelectIds.length && curTreeSelectIds.length != originalData.length;
                    ...
                    return (
                        <div key={item[idKey]}>
                            <Checkbox
                                ...
                                checked={
                                    selectIds && selectIds.filter((i) => i == item[idKey]).length > 0 ? true : false
                                }
