...
class TreeSelect extends React.Component {
    ...
    componentDidMount() {
        const { nodeType, treeData } = this.props;
        this.init(nodeType, treeData);
    }
    ...
    onExpand(expandedKeys, { expanded, node }) {
        ...
        if (expanded) {
            ...
            if (node.isParent == 1) {
                ...
                //       deptId: node.key,
                //       orgId: node.key,
                //       requireOrgPost: node.nodeType == 'DEPT' ? 'YES' : 'NO',
                //       isEnable: 1,
                //     },
                //     callback: function () {
                //       dispatch({
     ...
     */
    onSearchTree(value) {
        const { nodeType, dispatch, moudleName } = this.props;
